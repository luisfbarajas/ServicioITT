...
?>
    ...
    <div class="container">
     <br>
      <p class="Fecha-Texto">Las Fechas de los exámenes de inglés están programadas en la fecha y lugar especificados. 
      En cada fecha se cuenta con diferentes horarios en los cuales
       se puede presentar el examen para que se tenga la flexibilidad necesaria en cuanto horario se refiere.
      A continuación, se muestran las fechas de exámenes disponibles en el semestre en curso.
</p><br>      
          <div class="row" >
             <?php 
